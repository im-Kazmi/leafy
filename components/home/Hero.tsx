...
const Hero = () => {
  return (
    <div className=" w-full h-full flex   justify-center items-center py-28 max-h-[800px] ">
      <div className=" flex flex-col gap-3  text-center  m-auto  ">
        <h1 className=" text-5xl font-extrabold text-neutral-700 dark:text-neutral-100 selection:bg-neutral-200 selection:bg-opacity-50">
          <span className="text_gradient3 ">Leafy :</span> <br /> Your Source
          for <br />
          ...
          <span className="text_gradient2 ">Knowledge</span>
        </h1>
